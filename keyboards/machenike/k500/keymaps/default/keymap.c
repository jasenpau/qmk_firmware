...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        _______,    KC_SLEP,   _______,   _______,   _______,   KC_MPRV,   KC_MNXT,   KC_MPLY,   KC_MSTP,   KC_MUTE,   KC_VOLD,   KC_VOLU,   KC_NUM,    _______,   KC_PAUS,   DM_RSTP,
        _______,    KC_P1,     KC_P2,     KC_P3,     KC_P4,     KC_P5,     KC_P6,     KC_P7,     KC_P8,     KC_P9,     KC_P0,     _______,   _______,   _______,              DM_REC1,
        ...
        _______,    _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   KC_PDOT,   _______,             _______,               _______,   QK_BOOT,
